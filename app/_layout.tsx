    ...
    try {
      ...
      if (typeof await provider.passkey.store.getPasskey(result.id) === "undefined") {
        await provider.passkey.store.addPasskey({
          ...
          id: result.id,
          metadata: {
            origin: parsedClientData.origin || request.rpId || "",
    ...
    try {
      ...
      if (typeof await provider.passkey.store.getPasskey(result.id) === "undefined") {
        ...
        await provider.passkey.store.addPasskey({
          ...
          metadata: {
            ...
            userHandle: request.user.id ? toUint8Array(toArrayBuffer(request.user.id)) : null,
            challenge: parsedClientData.challenge,
          },
        })
      }
      ...
      return {
        ...
        response: {
          ...
          getPublicKeyAlgorithm: () => result.response.publicKeyAlgorithm || -7,
